// Renders Drift Cards — plain-language sentences derived from SYNTHETIC
// wellness data (see dashboard/src/wellness/). Never a diagnosis, never a
// score: just a sentence, a timestamp, and a way to flag it to her doctor.
...
export default function DriftCards({ cards, mentionedIds, onMentionToDoctor }) {
  if (cards.length === 0) {
    return (
